...
export default function DeleteButton({ id }: { id: number }) {
  ...
  return (
    <button
      ...
      className="bg-red-500 text-white text-center font-bold rounded-md p-1 capitalize m-auto block  hover:text-red-500 hover:bg-white duration-300 cursor-pointer shadow-xl w-full "
    >
      Delete
    </button>
  );
